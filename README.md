This script leverages ICMP Echo Request and ICMP Echo Reply to test the functionality of FortiSIEM configuration to trigger events like SSH Brute Force attack, Network Scan, and Computer Worm.
